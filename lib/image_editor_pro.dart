        ...
        appBar: new AppBar(
          actions: <Widget>[
            ...
            new IconButton(
                ...
                onPressed: () {
                  _controller.points.clear(); // to clear painted lines
                  setState(() {});
                }),
            new IconButton(
...
class ColorsPickerSlider extends StatefulWidget {
  @override
  _ColorsPickerSliderState createState() => _ColorsPickerSliderState();
}

class _ColorsPickerSliderState extends State<ColorsPickerSlider> {
  @override
  Widget build(BuildContext context) {
    return Container(
      padding: EdgeInsets.all(20),
